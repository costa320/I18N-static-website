        ...
        function (require, module, exports) {
          ...
          var getDefaults = function getDefaults() {
            return {
              ...
              reloadInterval:
                typeof window !== "undefined" ? false : 60 * 60 * 1000,
              customHeaders: {},
              queryStringParams: {},
              crossDomain: false,
            ...
            _createClass(Backend, [
                ...
                value: function init(services) {
                  ...
                  var allOptions =
                    arguments.length > 2 && arguments[2] !== undefined
                      ...
                      : {};
                  this.services = services;
                  this.options = (0, _utils.defaults)(
                    options,
                    this.options || {},
                    getDefaults()
                  );
                ...
                value: function loadUrl(url, callback, languages, namespaces) {
                  ...
                  this.options.request(
                    ...
                    function (err, res) {
                      if (
                        res &&
                        ((res.status >= 500 && res.status < 600) || !res.status)
                      )
                        return callback(
                          "failed loading " +
                            url +
              ...
              },
              {
                ...
                value: function create(
                  ...
                  languages.forEach(function (lng) {
                    ...
                    var url = _this3.services.interpolator.interpolate(
                      addPath,
                      {
                        lng: lng,
                        ns: namespace,
              ...
              },
              {
                ...
                value: function reload() {
                  ...
                  if (
                    currentLanguage &&
                    currentLanguage.toLowerCase() === "cimode"
                  )
                    return;
                  var toLoad = [];
        ...
        function (require, module, exports) {
          (function (global) {
            (function () {
              ...
              var requestWithFetch = function requestWithFetch(
                options,
                url,
                payload,
                callback
              ...
              var requestWithXmlHttpRequest = function requestWithXmlHttpRequest(
                options,
                url,
                payload,
                callback
